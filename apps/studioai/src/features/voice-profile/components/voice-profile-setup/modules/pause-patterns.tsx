...
export const PausePatterns: VoiceProfileModule = {
    ...
    description: "Control how often the voice pauses during speech. Lower values for continuous flow, higher values for more breathing space and dramatic pauses.",
    render: () => <Component />,
};
